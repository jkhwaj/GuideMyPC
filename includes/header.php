...
$pageDetails = [
    ...
    'admin_categories.php' => ['Manage Categories | GuideMyPC', 'Search and manage GuideMyPC support categories.'],
    'add_category.php' => ['Add Category | GuideMyPC', 'Create a GuideMyPC support category.'],
    'edit_category.php' => ['Edit Category | GuideMyPC', 'Update a GuideMyPC support category.'],
