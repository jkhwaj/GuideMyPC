...
<section class="profile-page" aria-labelledby="profile-title">
    <div class="profile-card"><h1 id="profile-title">My profile</h1><p>Welcome back, <?php echo e($account['full_name']); ?>.</p><div class="profile-info"><div><span>Email</span><strong><?php echo e($account['email']); ?></strong></div><div><span>Member since</span><strong><?php echo e($account['created_at']); ?></strong></div><div><span>Account</span><strong><?php echo e($account['role']); ?></strong></div></div><a class="secondary-btn" href="<?php echo e(application_url('settings.php')); ?>">Account settings</a> <a class="secondary-btn" href="<?php echo e(application_url('devices.php')); ?>">Signed-in browsers</a></div>
