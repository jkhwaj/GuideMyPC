...
<section class="profile-page admin-page">
    <div class="profile-card">
        ...
        <div class="admin-table-wrap"><table class="admin-table admin-guides-table"><colgroup><col class="admin-guides-table__guide"><col class="admin-guides-table__publication"><col class="admin-guides-table__category"><col class="admin-guides-table__progress"><col class="admin-guides-table__actions"></colgroup><caption class="visually-hidden">GuideMyPC guide administration results</caption><thead><tr><th scope="col">Guide</th><th scope="col">Publication</th><th scope="col">Category</th><th scope="col">Progress</th><th scope="col">Actions</th></tr></thead><tbody>
            <?php foreach ($listing['rows'] as $guide): ?>
                <tr><td><strong><?php echo e($guide['title']); ?></strong><br><code><?php echo e($guide['slug']); ?></code></td><td><span class="status-badge <?php echo (int) $guide['is_published'] === 1 ? 'status-published' : 'status-draft'; ?>"><?php echo (int) $guide['is_published'] === 1 ? 'Published' : 'Unpublished'; ?></span></td><td><?php echo e($guide['category_name'] ?? 'No category'); ?></td><td><?php echo number_format((int) $guide['step_count']); ?> steps<br><?php echo number_format((int) $guide['progress_count']); ?> saved</td><td><div class="admin-table-actions"><a href="<?php echo e(application_url('edit_guide.php?id=' . (int) $guide['id'])); ?>">Edit</a><?php if ($canDelete): ?><form class="inline-action" action="<?php echo e(application_url('delete_guide.php')); ?>" method="POST" onsubmit="return confirm('Delete this unused guide permanently?');"><?php echo csrf_field(); ?><input type="hidden" name="id" value="<?php echo (int) $guide['id']; ?>"><button type="submit">Delete</button></form><?php endif; ?></div></td></tr>
            <?php endforeach; ?>
