...
| `05-login-mobile-320px.png` | `login.php` | Guest | 320x800 | Responsive login at 320px | Narrow mobile login form with readable labels, controls, and the optional Remember me control | 2026-07-29 | Empty fields; no email address, password, cookie, token, or browser data is shown |
