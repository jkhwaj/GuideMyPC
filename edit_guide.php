...
<h2>Steps</h2><div id="stepsContainer"><?php $stepIndex = 0; while ($step = $steps->fetch_assoc()): ?><fieldset class="step-editor"><legend>Step <?php echo ++$stepIndex; ?></legend><label>Title <input name="steps[<?php echo $stepIndex - 1; ?>][title]" value="<?php echo e($step['step_title']); ?>"></label><label>Action <textarea name="steps[<?php echo $stepIndex - 1; ?>][text]" required><?php echo e($step['step_text']); ?></textarea></label><label>Expected result <textarea name="steps[<?php echo $stepIndex - 1; ?>][expected_result]"><?php echo e($step['expected_result']); ?></textarea></label><label>Warning <textarea name="steps[<?php echo $stepIndex - 1; ?>][warning_text]"><?php echo e($step['warning_text']); ?></textarea></label><label>Recovery path <textarea name="steps[<?php echo $stepIndex - 1; ?>][recovery_text]"><?php echo e($step['recovery_text']); ?></textarea></label></fieldset><?php endwhile; ?></div>
