...
<section class="auth-page"><div class="auth-card" style="max-width:900px;">
    ...
    <form method="POST"><?php echo csrf_field(); ?>
        ...
        <?php for ($index = 0; $index < max(3, count($sources)); $index++): $source = $sources[$index] ?? ['title' => '', 'official_url' => '']; ?><fieldset><legend>Source <?php echo $index + 1; ?></legend><label>Title <input name="sources[<?php echo $index; ?>][title]" maxlength="180" value="<?php echo e($source['title']); ?>"></label><label>HTTPS URL <input name="sources[<?php echo $index; ?>][official_url]" type="url" maxlength="255" value="<?php echo e($source['official_url']); ?>"></label></fieldset><?php endfor; ?>
